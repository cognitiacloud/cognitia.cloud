...
| --- | ---------------------------------------------------------- | --------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| T1  | Review & decide merge of #96 (compliance layer)            | Mgr + Eng | Ready — open, non-draft, **CI green**, converged on #93/#97 `[VERIFIED]` | Reviewer confirms: core has no duplicate compliance surface (already clean on `main`); view-models web-local importing #97 type-only; 620/620 tests reproduce | Name merge owner; do Day-1 review; schedule merge in an authorized session |
