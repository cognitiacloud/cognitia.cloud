...
- `verified_fact` — Cognitia over-indexes on honest, internal-quality docs; the
  gaps are *outward-facing* (API/SDK ref, consolidated security page, public
  roadmap, governance).
...
Do not publish a "whitepaper" implying a token offering; keep it a *protocol/
architecture* paper, token-gated.
