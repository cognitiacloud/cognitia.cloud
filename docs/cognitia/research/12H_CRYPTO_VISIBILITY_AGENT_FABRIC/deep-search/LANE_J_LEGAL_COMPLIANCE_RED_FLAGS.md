# LANE J — Legal / Compliance Red Flags (Canada/BC + US)

**Objective**: The legal/compliance landmines for an agent-economy project that
might one day have a token, with emphasis on Canada/BC and the US.

**Sources (WebSearch)**: manimama.eu (DD legal/risk 2026); North Dakota Securities
(AI-bot "investment education" scam alert); general securities/AML knowledge
...
- **Yield/APY/staking-rewards** language materially increases securities + consumer-
  protection risk. Cognitia already bans this.
- **AML/KYC**: real payments or token transfers can trigger money-services
  obligations (FINTRAC in Canada; FinCEN in the US). Cognitia uses internal,
  non-transferable credits → avoids this today.
- Marketing that promises performance, or uses "AI bot returns" framing, is a
...
- Add a public "compliance posture" note: internal credits only, no payments, no
