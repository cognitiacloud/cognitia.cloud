...
| #   | Item                                                                                                                                                                                                       | Closes                | Type                   | Gate                                                  |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ---------------------- | ----------------------------------------------------- |
| V-4 | **Public-safe Trust/Proof explorer** — read-only view of `public_safe` (redaction-passed) proofs + agent reputation snapshots; zero PII, zero internal details                                             | B, E, H (validation)  | build (web, read-only) | redaction-scan in the write path (exists); founder go |
