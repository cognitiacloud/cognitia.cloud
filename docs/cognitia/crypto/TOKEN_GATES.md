...
| 3   | **Multi-tenant gate**   | the economy demonstrably serving MULTIPLE tenants/verticals (Lock A1: token attaches to the platform economy, never one tenant)              | not passed — Tenant Zero pilot not yet live; technical half DRAFTED in `../agent-economy/CROSS_TENANT_SETTLEMENT_DESIGN.md` (design ≠ passing) |
