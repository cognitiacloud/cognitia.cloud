...
| ATC / credentials for agents        | ❌ none (credential*ciphertexts is for \_integration* credentials, e.g. HubSpot tokens — `verified_fact` from migration name + credentialStore.ts) |
