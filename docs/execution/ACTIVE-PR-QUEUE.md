...
| -------- | -------------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| **#99**  | Sales Closer Phase-2 Apify scaffold          | merged `c3quih` ⚠ | **Review + retarget _recommendation_ only.** Base branch already merged → must retarget→`main`, rebase, re-CI. Controller does **not** execute. |
...
## F. Queue hygiene rules (this session enforces by _recording only_)
