...
export function ComplianceNotice({
    ...
    return (
      ...
      >
        ...
        <p className="text-xs leading-relaxed text-ink-300">
          <span className="font-medium text-mint-300">Compliance-first.</span> CASL-ready consent
  ...
  return (
    <div className={`rounded-2xl border border-white/8 glass p-6 ${className}`}>
      <div className="mb-4 flex items-center gap-2">
        <ShieldIcon />
        <h3 className="font-display text-sm font-semibold uppercase tracking-[0.18em] text-mint-300">
          Trust &amp; Compliance
        </h3>
      </div>
